...
function initialize() {
  ...
  google.maps.event.addListener(map, "rightclick", function(event){
      ...
      $("#alert-submit").on('click', function(e){
        console.log("WOGOOO")
        var text = $("#alert-alert").val();
        var rad = $("#alert-rad").val();

        $.post(baserl+"index.php/admin/sendSMS", {rad: rad, text: text, lat: event.latLng.lat(), lng: event.latLng.lng()}, function(reply){
          alert("Done");
        })
      })
